...
| `enableInMemoryBitmap`            | Boolean        | If true, enable in memory bitmap for applicable dimensions when data is still in memory during real time writes before disk persistence triggers. Queries can leverage the bitmaps to avoid a full scan for this stage of data.                                                                                                                                                                                                                                                                                                                                                | no, default == false                                                                                         |
